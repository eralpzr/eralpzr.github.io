!function (e) {
    ...
    e(window).on("scroll", (function () {
        ...
        type: "image",
        gallery: {enabled: !0}
    }), e(".popup-video").magnificPopup({type: "iframe"}), e(".filter-active").imagesLoaded((function () {
    ...
    i.on("init", (function (s, t, a) {
        var n = e(t.$slides[t.currentSlide]), i = n.next(), o = n.next().next(), l = n.prev(), r = n.prev().prev();
        ...
        e(this).each((function () {
            var s = e(this), a = s.find(t.tabButton);
            ...
            function l() {
                var i = s.find(t.tabButton + ".active"), o = i.css("height"), l = i.css("width"),
                    r = i.position().top + "px", c = i.position().left + "px";
        ...
        let a = function () {
            t.x += .2 * (t.targetX - t.x), t.y += .2 * (t.targetY - t.y), s.css({transform: "translate(" + Math.floor(t.x - 5) + "px, " + Math.floor(t.y - 5) + "px)"}), requestAnimationFrame(a)
        };
        a()
